        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          <form className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-balance text-muted-foreground">Login to your ISToresumido account</p>
              </div>
              ...
              <div className="text-center text-sm">
                ...
                <a href="#" className="underline underline-offset-4 text-primary hover:text-[#007bb1]">
                  Sign up
                </a>
              </div>
            </div>
          ...
          <div className="relative flex flex-col items-center justify-center bg-muted p-6 md:p-8">
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <p className="mb-4 text-sm text-muted-foreground">Passwordless sign-in with enhanced security</p>
